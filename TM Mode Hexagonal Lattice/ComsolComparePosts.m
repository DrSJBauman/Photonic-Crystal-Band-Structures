function ResultPlots = ComsolComparePosts(Nk, Nmesh, lbda, Mpoint, Kpoint)
...
FEMdata30 = importdata('FEMdataPosts30.mat'); % Matrix of wavelength and reflectance COMSOL values for 45º incidence
