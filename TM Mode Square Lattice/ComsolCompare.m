function ResultPlots = ComsolCompare(Nk, Nmesh, lbda, Xpoint)
...
FEMdata0 = importdata('FEMdata0.mat'); % Matrix of wavelength and reflectance COMSOL values for 0º incidence
FEMdata45 = importdata('FEMdata45.mat'); % Matrix of wavelength and reflectance COMSOL values for 45º incidence
