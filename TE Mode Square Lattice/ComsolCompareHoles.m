function ResultPlots = ComsolCompareHoles(Nk, Nmesh, lbda, Xpoint)
...
FEMdata45 = importdata('FEMdataHoles45.mat'); % Matrix of wavelength and reflectance COMSOL values for 45º incidence
